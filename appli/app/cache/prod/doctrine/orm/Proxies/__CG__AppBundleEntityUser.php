...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'birthdate', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'cp', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'ville', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'photo');
        }
